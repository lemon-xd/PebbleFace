...
strftime(time_buffer, sizeof(time_buffer), "%H", tick_time);
...
text_layer = text_layer_create(GRect(72, 84, 72, 34));
text2_layer = text_layer_create(GRect(72, 114, 72, 34));
 
// Set the text, font, and text alignment
text_layer_set_font(text_layer, fonts_get_system_font(FONT_KEY_BITHAM_34_MEDIUM_NUMBERS));
text_layer_set_font(text2_layer, fonts_get_system_font(FONT_KEY_BITHAM_34_MEDIUM_NUMBERS));
